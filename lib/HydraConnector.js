 ...
 * @param @param {function(Object, Object)} callback Callback that gets invoked when the operation finishes. On error, it sets the first parameter to an error message.
 */
